...
behavior and may take fair corrective action in response to unacceptable behavior.
...
Maintainers may apply the following actions depending on severity and pattern:
1. Correction: private or public request to stop the behavior.
2. Warning: notice with consequences for continued behavior.
3. Temporary ban: time-limited restriction from interaction.
4. Permanent ban: long-term or indefinite restriction from participation.
